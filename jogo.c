...
int main(void){
    int retorno_tela_inicial = 0, retorno_fase1 = 0, loop = 0, frame_ativo = 0;
	...
	retorno_fase1 = fase_1(retorno_tela_inicial, loop, frame_ativo);
...
int fase_1(int retorno, int loop, int frame_ativo)
{
